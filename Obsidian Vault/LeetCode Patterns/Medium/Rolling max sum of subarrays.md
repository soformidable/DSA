...
--> Always initialize the temp sum and max sum with nums[0]
--> Alkways use a for loop from i = 1 
--> For each will add the first element to sum and max_sum making the sum incorrect
